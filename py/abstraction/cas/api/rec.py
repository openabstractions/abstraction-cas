...
REFUSALS = ["malformed", "bad_string", "number_spelling", "wrong_type", "bad_binary", "depth_exceeded", "duplicate_key", "duplicate_field", "unknown_field", "missing_field", "trailing_bytes"]
...
class Store:
    __doc__ = "Compare-and-set over a file. This descriptor is emitted as a direct language interface with no IPC. Native providers own locking and replacement. The wire_name is schema metadata, not an available service endpoint."
